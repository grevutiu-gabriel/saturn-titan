...
namespace ld
{
    ...
    public:
        ...
        long double& real(void) { return m_real; }
        const long double& real(void) const { return m_real; }

        ///  Return imaginary part of complex number.
        long double& imag(void) { return m_imag; }
        const long double& imag(void) const { return m_imag; }
